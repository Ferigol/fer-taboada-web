    ...
    "relative group border text-foreground mx-auto text-center rounded-full",
    {
        variants: {
            variant: {
                ...
                solid: "bg-orange-500 hover:bg-orange-600 text-white border-transparent hover:border-foreground/50 transition-all duration-200",
                ghost: "border-transparent bg-transparent hover:border-zinc-600 hover:bg-white/10",
            },
            size: {
                default: "px-10 py-3 text-sm font-bold tracking-widest uppercase",
            },
        },
        defaultVariants: {
            variant: "default",
